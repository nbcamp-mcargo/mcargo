...
public class DeliveryController {
    ...
    public ApiResponse<UUID> cancelDelivery(@PathVariable UUID deliveryId) {
        // TODO: 사용자 정보 추가

        deliveryService.cancelDelivery(deliveryId);

        return ApiResponse.of(DeliveryResponseCode.DELIVERY_STATUS_CANCELED, deliveryId);
    }

    // 배송 삭제
    @DeleteMapping("/{deliveryId}")
    public ApiResponse<UUID> deleteDelivery(@PathVariable UUID deliveryId) {
        deliveryService.deleteDelivery(deliveryId);

        return ApiResponse.of(DeliveryResponseCode.DELIVERY_INFO_DELETED, deliveryId);
    }
    ...
    public ApiResponse<Page<ResDeliveryDetailDto>> searchDeliveries(
        ...
        Page<ResDeliveryDetailDto> deliverySearchPage = deliveryService.searchDeliveries(deliverySearchParam, pageable);
